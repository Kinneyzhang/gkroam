...
** Installation
   ...
   Clone this repo and add gkroam to your emacs load-path. My configurations are as follows. Feel free to modify them as your preference.
...
** Tips (important)
   ...
   - Use =gkroam-build-caches= to generate all headlines ids and cache them in db manually when you put your org files in gkroam directory at the very first time..
