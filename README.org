...
** Install
   ...
   (use-package gk-roam
	...
	(("r f" gk-roam-find "find file")
	 ...
	 ("r i" gk-roam-insert "insert links")
...
** Todo List
   ...
   * [X] Insert linked references at the bottom of page.
   ...
   * [X] Convert gk-roam link to org file link when publish project and convert back when published.
